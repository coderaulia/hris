...
6. **HR Documents** — dynamic templates + preview + PDF export for offer/contract/payslip/warning/termination letters
...
- E-signature or approval-sign workflow for generated HR documents
