...
- Backend: Supabase Auth + Postgres + RLS, plus first-pass Supabase Edge Functions for privileged and callback/export boundaries
...
- Implemented first-pass function domains:
